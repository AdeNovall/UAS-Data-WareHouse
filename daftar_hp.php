...
<?php 
	if(isset($_POST["tambah_hp"])){
		...
		elseif($chipset == "Exynos"){
			$chipset_angka = 4;
		}
		elseif($chipset == "Snapdragon"){
			$chipset_angka = 5;
		}
		...
		$sql = "INSERT INTO `data_hp` (`id_hp`, `nama_hp`, `harga_hp`, `ram_hp`, `memori_hp`, `chipset_hp`, `kamera_hp`, `harga_angka`, `ram_angka`, `memori_angka`, `chipset_angka`, `kamera_angka`) 
				VALUES (NULL, :nama_hp, :harga_hp, :ram_hp, :memori_hp, :chipset_hp, :kamera_hp, :harga_angka, :ram_angka, :memori_angka, :chipset_angka, :kamera_angka)";
		$stmt = $db->prepare($sql);
		$stmt->bindValue(':nama_hp', $nama);
		$stmt->bindValue(':harga_hp', $harga);
		$stmt->bindValue(':ram_hp', $ram);
		$stmt->bindValue(':memori_hp', $memori);
		$stmt->bindValue(':chipset_hp', $chipset);
		...
		$stmt->bindValue(':chipset_angka', $chipset_angka);
									...
									<table id="table_id" class="hover dataTablesCustom" style="width:100%">
											...
											<tbody>
												...
												<tr>
													...
													<td><center><?php echo $data['chipset_hp'] ?></center></td>
									...
									<table class="responsive-table">
											...
											<tbody>
												...
												<tr>
													...
													<td><center><?php echo $data['chipset_angka'] ?></center></td>
							...
							<form method="POST" action="">
								<div class = "row">
									<div class="col s12">
										...
										<div class="col s6">
											<select style="display: block; margin-bottom: 4px;" required name="chipset">
