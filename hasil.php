									...
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($data_hp=mysqli_fetch_array($query)) {
												$Matrik[$no-1]=array($data_hp['harga_angka'],$data_hp['ram_angka'],$data_hp['memori_angka'],$data_hp['chipset_angka'],$data_hp['kamera_angka'] );
												?>
												<tr>
													...
													<td><center><?php echo $data_hp['chipset_angka'] ?></center></td>
										...
										<tbody>
											...
											while ($data_hp=mysqli_fetch_array($query)) {
												...
												$MatrikNormalisasi[$no-1]=array($data_hp['harga_angka']/$pembagiNM[0],
													...
													$data_hp['chipset_angka']/$pembagiNM[3],
													...
													<tr>
														...
														<td><center><?php echo round($data_hp['chipset_angka']/$pembagiNM[3],6) ?></center></td>
